...
export const fr = createLocale({
  ...
  updates: {
    eyebrow: 'Nouveautés de la version {version}',
    title: 'Une meilleure fenêtre pour Chrome',
    description: 'L’espace de travail s’ouvre maintenant à une taille fiable et garde toutes les commandes lisibles.',
    layoutTitle: 'Plus de place pour calculer',
    layoutDescription: 'Calculateur, résultats, comparaisons et historique tiennent sans être coupés.',
    noticeTitle: 'Notes de mise à jour uniques',
    noticeDescription: 'Cet écran apparaît une seule fois après chaque nouvelle version.',
    privacyTitle: 'Toujours privé par conception',
    privacyDescription: 'Vos calculs, préférences et historique restent sur votre appareil.',
    releaseNotes: 'Notes de version',
    support: 'Nous soutenir',
    continue: 'Commencer le calcul',
