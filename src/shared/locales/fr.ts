...
export const fr = createLocale({
  ...
  "whole": "Saisissez un nombre entier de mensualités.",
  "paired": "Saisissez le nombre de mensualités et le total payé.",
  "resaleLimit": "La revente ne peut pas dépasser le total payé plus l’entretien.",
  "usageRange": "Ajustez la durée ou la fréquence pour obtenir au moins une utilisation et un total raisonnable."
},
  updates: {
    eyebrow: 'Nouveautés de la version {version}',
    title: "Plus de recul avant d’acheter",
    description: "Comparez un usage réduit et fixez un objectif personnel avant de décider.",
    scenariosTitle: "Et si vous l’utilisez moins ?",
    scenariosDescription: "Comparez le coût prévu par utilisation avec un usage divisé par deux.",
    targetTitle: "Fixez votre objectif",
    targetDescription: "Découvrez le nombre minimal d’utilisations pour atteindre votre coût cible.",
