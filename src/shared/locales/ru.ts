...
export const ru = createLocale({
  ...
  results: {
    target: {
      title: "Ваша цель по стоимости использования",
      help: "Необязательно. Укажите максимальную желаемую стоимость одного использования.",
      label: "Цель за использование ({currency})",
      usesNeeded: "Всего нужно использований",
      withinEstimate: "Ожидаемого числа использований достаточно для достижения цели.",
      beyondEstimate: "Дополнительные использования сверх вашей оценки: {uses}.",
      assumption: "Чистые затраты остаются прежними, включая перепродажу, обслуживание и рассрочку.",
      invalid: "Введите цель больше нуля.",
      outOfRange: "Для этой цели нужно слишком много использований для точного расчёта. Попробуйте увеличить целевую стоимость.",
    },
    scenarios: {
    ...
    ratings: {
      excellent: "Ожидаемое общее число использований за срок владения. Само по себе число использований не определяет доступность покупки; сравните стоимость одного использования со своим бюджетом.",
      good: "Ожидаемое общее число использований за срок владения. Само по себе число использований не определяет доступность покупки; сравните стоимость одного использования со своим бюджетом.",
      think_twice: "Ожидаемое общее число использований за срок владения. Само по себе число использований не определяет доступность покупки; сравните стоимость одного использования со своим бюджетом.",
      expensive: "Ожидаемое общее число использований за срок владения. Само по себе число использований не определяет доступность покупки; сравните стоимость одного использования со своим бюджетом.",
    },
    ratingLabels: {
      excellent: "200+ использований",
      good: "50–199 использований",
      think_twice: "20–49 использований",
      expensive: "Менее 20 использований",
    },
  ...
  "nonnegative": "Введите ноль или положительное число.",
  "whole": "Введите целое количество платежей.",
  "paired": "Введите количество платежей и общую сумму.",
  "resaleLimit": "Цена перепродажи не может превышать общую сумму с обслуживанием.",
  "usageRange": "Измените срок или частоту, чтобы получить хотя бы одно использование и разумное общее количество."
},
  updates: {
    eyebrow: 'Новое в версии {version}',
    title: "Больше ясности перед покупкой",
    description: "Сравните более редкое использование и задайте свою цель.",
    scenariosTitle: "А если пользоваться реже?",
    scenariosDescription: "Сравните ожидаемую стоимость использования с использованием вдвое реже.",
    targetTitle: "Задайте свою цель",
    targetDescription: "Узнайте минимальное количество использований для достижения нужной стоимости.",
