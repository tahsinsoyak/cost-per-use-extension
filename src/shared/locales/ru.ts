...
export const ru = createLocale({
  ...
  updates: {
    eyebrow: 'Новое в версии {version}',
    title: 'Улучшенное окно для Chrome',
    description: 'Рабочая область теперь открывается в полном размере, а все элементы остаются читаемыми.',
    layoutTitle: 'Больше места для расчётов',
    layoutDescription: 'Калькулятор, результаты, сравнения и история помещаются без обрезки.',
    noticeTitle: 'Однократные заметки об обновлении',
    noticeDescription: 'Этот экран показывается один раз после каждой новой версии.',
    privacyTitle: 'Конфиденциальность по умолчанию',
    privacyDescription: 'Расчёты, настройки и сохранённая история остаются на вашем устройстве.',
    releaseNotes: 'Примечания к выпуску',
    support: 'Поддержать',
    continue: 'Начать расчёт',
