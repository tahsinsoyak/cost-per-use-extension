...
export const ptBR = createLocale({
  ...
  validation: {
  "positive": "Insira um número maior que zero.",
  "nonnegative": "Insira zero ou um número positivo.",
  "whole": "Insira um número inteiro de parcelas.",
  "paired": "Informe o número de parcelas e o total pago.",
  "resaleLimit": "A revenda não pode superar o total pago mais a manutenção.",
  "usageRange": "Ajuste o período ou a frequência para obter pelo menos um uso e um total razoável."
},
  updates: {
    eyebrow: 'Novidades da versão {version}',
    title: "Mais perspectiva antes de comprar",
    description: "Compare um uso menor e defina uma meta pessoal antes de decidir.",
    scenariosTitle: "E se você usar menos?",
    scenariosDescription: "Compare o custo por uso esperado com metade do uso.",
    targetTitle: "Defina sua própria meta",
    targetDescription: "Veja o mínimo de usos para atingir sua meta de custo por uso.",
