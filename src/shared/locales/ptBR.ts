...
export const ptBR = createLocale({
  ...
  updates: {
    eyebrow: 'Novidades da versão {version}',
    title: 'Um pop-up melhor para o Chrome',
    description: 'O espaço de trabalho agora abre em tamanho confiável e mantém todos os controles legíveis.',
    layoutTitle: 'Mais espaço para calcular',
    layoutDescription: 'Calculadora, resultados, comparações e histórico cabem sem cortes.',
    noticeTitle: 'Notas de atualização únicas',
    noticeDescription: 'Esta tela aparece apenas uma vez após cada nova versão.',
    privacyTitle: 'Privacidade desde o início',
    privacyDescription: 'Seus cálculos, preferências e histórico continuam no seu dispositivo.',
    releaseNotes: 'Notas da versão',
    support: 'Apoiar',
    continue: 'Começar a calcular',
