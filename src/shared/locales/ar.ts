...
export const ar = createLocale({
  ...
  validation: {
  "positive": "أدخل عددًا أكبر من الصفر.",
  "nonnegative": "أدخل صفرًا أو عددًا موجبًا.",
  "whole": "أدخل عددًا صحيحًا للأقساط.",
  "paired": "أدخل عدد الأقساط وإجمالي المبلغ المدفوع معًا.",
  "resaleLimit": "لا يمكن أن تتجاوز قيمة إعادة البيع إجمالي المدفوع مع الصيانة.",
  "usageRange": "عدّل المدة أو التكرار للحصول على استخدام واحد على الأقل وإجمالي معقول."
},
  updates: {
    eyebrow: 'الجديد في الإصدار {version}',
    title: "رؤية أوضح قبل الشراء",
    description: "قارن الاستخدام الأقل وحدد هدفًا شخصيًا قبل اتخاذ القرار.",
    scenariosTitle: "ماذا لو استخدمته أقل؟",
    scenariosDescription: "قارن تكلفة الاستخدام المتوقعة بالتكلفة عند نصف الاستخدام.",
    targetTitle: "حدد هدفك الخاص",
    targetDescription: "اكتشف أقل عدد من الاستخدامات للوصول إلى التكلفة المستهدفة لكل استخدام.",
