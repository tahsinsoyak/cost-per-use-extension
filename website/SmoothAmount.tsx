...
export function SmoothAmount({value,currency,lang}:{value:number|null;currency:string;lang:SiteLanguage}) {
  ...
  useEffect(()=>{
    ...
    if(!node) return;
    const format=new Intl.NumberFormat(languageLocale(lang),{style:'currency',currency});
