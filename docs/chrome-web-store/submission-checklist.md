...
- Confirm the dashboard recognizes package version `1.0.1`.
...
- Add the no-login reviewer instructions from `releases/v1.0.1.md`; leave username and password blank.

## Final review

- Verify the Patreon link is voluntary and does not unlock features.
- Confirm every listing claim matches version `1.0.1`.
